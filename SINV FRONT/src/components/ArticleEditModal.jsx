...
import { FaTimes, FaBox, FaCheck, FaExclamationTriangle, FaSave } from 'react-icons/fa';

const ArticleEditModal = ({ isOpen, onClose, onArticleUpdated, articleData, existingArticles }) => {
    ...
    useEffect(() => {
        if (isOpen && articleData && initialLoad) {
            setFormData({
                id: articleData.id,
                ...
                storageIds: articleData.storages ? articleData.storages.map(s => s.id) : []
            });
            setInitialLoad(false);
        }
    }, [isOpen, articleData, initialLoad]);
                                ...
                                <div className="pt-4 border-t border-gray-700/50 flex justify-end gap-3">
                                    ...
                                    >
                                        {loading ? (
                                            ...
                                            <>
                                                <FaSave className="h-4 w-4" /> Guardar Cambios
                                            </>
                                        )}
                                    </motion.button>
                                </div>
