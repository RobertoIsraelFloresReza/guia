...
import {
  ...
  FaCog, FaBell, FaSearch, FaBook, FaCalendarAlt,
  FaFileAlt, FaUsers, FaHistory, FaBookOpen, FaGlobe
} from "react-icons/fa";
...
const AdminLayout = () => {
  ...
  const signOut = async () => {
    ...
    try {
      await new Promise(resolve => setTimeout(resolve, 1000)); // Simular proceso de logout
      localStorage.clear();
  ...
  const navItems = [
    { to: "/administrador/home", icon: <FaHome />, text: "Inicio" },
    { to: "/administrador/storages", icon: <FaBookOpen />, text: "Almacenes" },
    { to: "/administrador/categories", icon: <FaGlobe />, text: "Categorías" },
    { to: "/administrador/articles", icon: <FaFileAlt />, text: "Artículos" },
    { to: "/administrador/responsables", icon: <FaUsers />, text: "Responsables" },
  ];
        ...
        <div className="w-full px-4">
          <div className="flex justify-between items-center h-16 max-w-7xl mx-auto">
            ...
            <div className="flex items-center space-x-3">
              ...
              <NavLink to="/administrador/home" className="flex items-center space-x-2 group">
            ...
            <div className="flex flex-col h-full p-4">
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center space-x-2">
                  <div className="relative">
                    <img src={NeonLogo} alt="Logo" className="h-10 glow-cyan" />
                    <div className="absolute inset-0 rounded-full bg-cyan-500/20 blur-md -z-10"></div>
                  </div>
                  <span className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
                    SINV<span className="font-light">HUB</span>
