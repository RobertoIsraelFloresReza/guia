...
const EditAdminModel = ({ showModalEdit, closeModalEdit, clienteEditando, refreshClients }) => {
            ...
            >
                ...
                <div className="p-6 pb-4 flex justify-between items-center border-b border-gray-200/30">
                    <div>
                        ...
                        <p className="text-sm text-purple-700/80 mt-1">Actualice la información del Administrador</p>
                    </div>
                    <motion.button
